...
function updateInputPlaceholders() {
  setInputPlaceholder('email', 'email address');
  setInputPlaceholder('password', 'password');
}

function updateLabels() {
  setLabelInnerHTML('label[for="email"]', 'Email<span class="required-asterisk">*</span>');
...
function validateForm(event, form) {
  ...
  isValid &= validateInput(email, 'The email address was not found. Please try again or contact your system administrator.');
